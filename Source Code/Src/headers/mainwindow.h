...
public:
    const std::string credFilepath = "../Src/appconfig/credentials.txt";
    const std::string userFilepath = "../Src/appconfig/userConfig.txt";
    const std::string roomFilepath = "../Src/appconfig/roomConfig.txt";
    const std::string adminFilepath = "../Src/appconfig/roomAdminConfig.txt";
