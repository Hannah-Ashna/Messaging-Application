...
void MainWindow::updateFile(std::string filePath) {
    ...
    else throw std::runtime_error("Error Opening File");
    file.close();
}
...
void MainWindow::read_userConfig(std::string username)
{
    ...
    configFile.open(userFilepath, std::ios::in);
    if(!configFile){ throw std::runtime_error("Error Opening File"); }
    else {
        while (std::getline(configFile, line)) {
...
void MainWindow::read_roomConfig(std::string roomName)
{
    ...
    if(roomConfigFile){
        ...
        notifyUser(Consts::errors.missingFile);
...
void MainWindow::on_loginButton_clicked()
{
    ...
    */
    ...
    if(!credentialsFile){ throw std::runtime_error("Error Opening File"); }
    else {        
